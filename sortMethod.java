...
public class sortMethod {
            ...
            switch (met) {
                case 1:
                    ...
                    for(int i=0;i<rep;i++){
                        ...
                        sumsordMethod(Arr);
                        t2 = System.nanoTime();
                        System.out.print("Method: "+ met+ "\tIter: "+i+"\tTime: "+ (t2-t1)+"\n");
                    }
                    break;
    ...
    private static void timsortMethod(int[] a){
        ...
        for(int i=0;i<a.length+1;i+=count){

            for(int ii=i+1;ii<=Math.min((i+(count-1)),(a.length-1));ii++){
                int temp=a[ii];
                int j=ii-1;
                while(j>=i && a[j]>temp){
                    a[j+1]=a[j];
        ...
        for(int size=count;size<a.length;size=2*size){
